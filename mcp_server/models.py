...
class CertificateParameters(BaseModel):
    ...
    PrnNo: str = Field(..., description='PRN No.', examples=['MA90120190002'])
    RequestId: str = Field(..., description='Request ID', examples=['1234'])
...
class AdcrdCertificatePostRequest(BaseModel):
...
class AdcrdCertificatePostResponse(BaseModel):
...
class AdcrdCertificatePostResponse1(BaseModel):
...
class AdcrdCertificatePostResponse2(BaseModel):
...
class AdcrdCertificatePostResponse3(BaseModel):
...
class AdcrdCertificatePostResponse4(BaseModel):
...
class AdcrdCertificatePostResponse5(BaseModel):
...
class AdcrdCertificatePostResponse6(BaseModel):
